...
| Fall 2019    | Took the following courses:<br />- Programming Language Design and Implementation: 6 projects in total, and writing code in about 9 different  programming languages. So far, Haskell, Ada, Prolog, Java, Python, Go, and C++. <br/>- Computer Organization: writing code mainly in C and assembly. <br/>- Data Mining (graduate level): using Python as the main language. <br/>Besides schools: writing mini tools in Go, getting more and more comfortable with Unix tools, using vim for most of my coding, and learning, learning, learning... |
